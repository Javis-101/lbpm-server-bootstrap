...
Repository `main` is `1.0.4-dev` because it includes a later installer path-safety change. It has static regression evidence only and is not a production-validated replacement for this frozen v1.0.3 release.
